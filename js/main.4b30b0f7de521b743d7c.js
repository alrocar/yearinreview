...
(window.webpackJsonp = window.webpackJsonp || []).push([[0], {
    ...
    P3Nu: function(e, t) {
        var o, i, n = Math.abs, a = function(e) {
            var t = {
                addEvent: function(e, t, o, i) {
                    e.addEventListener ? e.addEventListener(t, o, !1) : e.attachEvent && (e["e" + t + o] = o,
                    e[t + o] = function() {
                ...
                iphone: {
                    ...
                    touchmoveHandler: function(o) {
                        if (1 === o.touches.length && !0 === t.iphone.capture) {
                            var e = o.touches[0];
                            t.iphone.stop_x = e.pageX,
                            t.iphone.stop_y = e.pageY,
                            t.iphone.tap = !1,
                            t.iphone.capture = !1,
                    ...
                    touchendHandler: function() {
                        if (t.iphone.input.push(t.iphone.check_direction()),
                        t.iphone.input.length > t.iphone.keys.length && t.iphone.input.shift(),
                        t.iphone.input.length === t.iphone.keys.length) {
                            for (var e = !0, o = 0; o < t.iphone.keys.length; o++)
                                t.iphone.input[o] !== t.iphone.keys[o] && (e = !1);
                            e && t.iphone.code(t._currentLink)
                        }
                    },
                    touchstartHandler: function(o) {
                        t.iphone.start_x = o.changedTouches[0].pageX,
                        t.iphone.start_y = o.changedTouches[0].pageY,
                        t.iphone.tap = !0,
                        t.iphone.capture = !0
                    },
                    load: function() {
                        this.orig_keys = this.keys,
                        t.addEvent(document, "touchmove", this.touchmoveHandler),
                        t.addEvent(document, "touchend", this.touchendHandler, !1),
                        t.addEvent(document, "touchstart", this.touchstartHandler)
                    },
                    unload: function() {
                        t.removeEvent(document, "touchmove", this.touchmoveHandler),
                        t.removeEvent(document, "touchend", this.touchendHandler),
                        t.removeEvent(document, "touchstart", this.touchstartHandler)
                    },
                    check_direction: function() {
                        return x_magnitude = n(this.start_x - this.stop_x),
                        y_magnitude = n(this.start_y - this.stop_y),
                        x = 0 > this.start_x - this.stop_x ? "RIGHT" : "LEFT",
                        y = 0 > this.start_y - this.stop_y ? "DOWN" : "UP",
        ...
        "undefined" == typeof e.exports ? (o = [],
        i = function() {
            return a
        }
        .apply(t, o),
        !(void 0 !== i && (e.exports = i))) : e.exports = a
    },
    WQPq: function() {},
    kpGR: function(e, t, o) {
        "use strict";
        ...
        class K {
            constructor(e, t) {
                ...
                this.element.addEventListener("touchstart", this._onTouchStart, Q),
                this.element.addEventListener("touchmove", this._onTouchMove, Q),
                this.element.addEventListener("touchend", this._onTouchEnd, Q),
                this.opts.mouseSupport && !("ontouchstart"in window) && (this.element.addEventListener("mousedown", this._onTouchStart, Q),
                document.addEventListener("mousemove", this._onTouchMove, Q),
                document.addEventListener("mouseup", this._onTouchEnd, Q))
            }
            destroy() {
            ...
            fire(e, t) {
                for (let o = 0; o < this.handlers[e].length; o++)
                    this.handlers[e][o](t)
            }
            onTouchStart(e) {
            ...
            onTouchMove(e) {
                if ("mousemove" !== e.type || this.touchStartX && null === this.touchEndX) {
                    ...
                    this.velocityX = t - this.touchMoveX,
                    this.touchMoveX = t;
                    const o = ("mousemove" === e.type ? e.screenY : e.changedTouches[0].screenY) - this.touchStartY;
                    this.velocityY = o - this.touchMoveY,
                    this.touchMoveY = o;
                    const i = j(this.touchMoveX)
                      , n = j(this.touchMoveY);
                    this.swipingHorizontal = i > this.thresholdX,
                    this.swipingVertical = n > this.thresholdY,
                    this.swipingDirection = i > n ? this.swipingHorizontal ? "horizontal" : "pre-horizontal" : this.swipingVertical ? "vertical" : "pre-vertical",
                    O(i, n) > this.opts.pressThreshold && clearTimeout(this.longPressTimer),
                    this.fire("panmove", e)
                }
            }
            onTouchEnd(e) {
                if ("mouseup" !== e.type || this.touchStartX && null === this.touchEndX) {
                    ...
                    const t = this.touchEndX - this.touchStartX
                      ...
                      , n = j(i);
                    o > this.thresholdX || n > this.thresholdY ? (this.swipedHorizontal = this.opts.diagonalSwipes ? j(t / i) <= this.opts.diagonalLimit : o >= n && o > this.thresholdX,
                    this.swipedVertical = this.opts.diagonalSwipes ? j(i / t) <= this.opts.diagonalLimit : n > o && n > this.thresholdY,
                    this.swipedHorizontal && (0 > t ? (this.velocityX < -this.opts.velocityThreshold || t < -this.disregardVelocityThresholdX) && this.fire("swipeleft", e) : (this.velocityX > this.opts.velocityThreshold || t > this.disregardVelocityThresholdX) && this.fire("swiperight", e)),
                    this.swipedVertical && (0 > i ? (this.velocityY < -this.opts.velocityThreshold || i < -this.disregardVelocityThresholdY) && this.fire("swipeup", e) : (this.velocityY > this.opts.velocityThreshold || i > this.disregardVelocityThresholdY) && this.fire("swipedown", e))) : o < this.opts.pressThreshold && n < this.opts.pressThreshold && (this.doubleTapWaiting ? (this.doubleTapWaiting = !1,
                    clearTimeout(this.doubleTapTimer),
                    this.fire("doubletap", e)) : (this.doubleTapWaiting = !0,
        ...
        var Z = o("xC2a")
          ...
          , ie = function() {
            ...
            return a(e, [{
                      ...
                      , s = function(e) {
                        o.assetList[e].forEach(function(t) {
                            if (~t.indexOf(".mp4")) {
                                ...
                                i.style = "position:absolute;height:0",
                                i.muted = !0,
                                i.autoplay = !1,
                                i.loop = !0,
                                ...
                                i.preload = "metadata",
                                i.src = "assets/".concat(e, "/").concat(t),
                    ...
                    for (var c = new $.a, p = ["fonts/schnyder.json", "fonts/schnyder-outline.json", "fonts/suisse.json"], m = function(e) {
                        n.push(new Promise(function(t) {
                            return c.load(p[e], function(e) {
                                o.assets.fonts[e.data.familyName] = e,
                                t()
                            })
                        }
                        ))
                ...
                value: function(e, t) {
                    ...
                    this.progressEl.innerHTML = o + "%",
                    this.progressBar.style.strokeDashoffset = 252.363 - 252.363 * (e / t)
                }
            }, {
                key: "videoPromise",
                value: function(e, t, o, i, n) {
                    var a = this;
                    n && e.load(),
                    this.isMobile ? (e.onloadeddata = function() {
                        e.onerror = null,
                        a.createVideoTexture(e, t, o, i)
                    }
                    ,
                    e.onerror = function() {
                        e.onloadeddata = null,
                        a.videoPromise(e, t, o, i, !0)
                    }
                ...
                value: function(e, t, o, i) {
                    ...
                    if (i)
                        ...
                        e.mediaType = "image",
                        e.anisotropy = this.renderer.capabilities.getMaxAnisotropy(),
                        this.assets.textures[t] || (this.assets.textures[t] = {}),
                        this.assets.textures[t][o] = e,
                        i(e);
                    else {
                        ...
                        a.size = new Y.a(10,10),
                        a.name = "".concat(t, "/").concat(o),
                        a.mediaType = "image",
                        a.anisotropy = this.renderer.capabilities.getMaxAnisotropy(),
                        this.assets.textures[t] || (this.assets.textures[t] = {}),
                        this.assets.textures[t][o] = a
                    }
                }
            }, {
                ...
                value: function(e, t, o, i) {
                    var n = new ee.a(e);
                    n.minFilter = n.magFilter = te.M,
                    n.name = "".concat(t, "/").concat(o),
                    n.mediaType = "video",
                    n.anisotropy = this.renderer.capabilities.getMaxAnisotropy(),
                    i ? (n.size = new Y.a(n.image.videoWidth / 2,n.image.videoHeight / 2),
                    this.renderer.setTexture2D(n, 0),
                    this.isMobile ? (e.src = "",
                    e.load(),
                    e.onloadeddata = null) : e.oncanplaythrough = null,
                    i(n)) : (n.size = new Y.a(1,1),
                    e.oncanplaythrough = function() {
          ...
          , ce = function(e) {
            function t() {
                ...
                return s(this, t),
                e = p(this, m(t).call(this)),
                Object.assign(g(g(e)), o),
                e.create(),
                e
            }
            return d(t, e),
            c(t, [{
                ...
                value: function() {
                    ...
                    this.texture.onUpdate = function() {
                        e.mesh.scale.x !== e.texture.size.x && e.mesh.scale.y !== e.texture.size.y && (e.mesh.scale.set(e.texture.size.x, e.texture.size.y, 1),
                        e.texture.onUpdate = null)
                    }
                    ;
                    ...
                    3 == t && o.set(-350, -350),
                    this.align = t,
                    this.position.set(o.x, o.y, -300 * this.itemIndex - 200),
                ...
                value: function() {
                    if (("" !== this.data.caption || "" !== this.data.link) && "" !== this.data.caption) {
                        ...
                        this.caption = new V.a(e,this.timeline.captionTextMat),
          ...
          , de = function(e) {
            function t() {
                ...
                return f(this, t),
                e = k(this, w(t).call(this)),
                Object.assign(_(_(e)), o),
                "intro" === e.section ? e.createIntroSection() : "end" === e.section ? e.createEndSection() : "contact" === e.section ? e.createContactSection() : e.create(),
                e
            }
            return C(t, e),
            v(t, [{
                ...
                value: function() {
                    ...
                    var n = new X.a({
                      ...
                      , a = new q.b(1,1)
                      , r = new V.a(a,n);
                    r.scale.set(300, 300, 1),
                    r.position.set(0, 200, -250),
                    this.add(r),
                    this.addIntroBadge()
                    ...
                    // var material = new X.a({ wireframe: true });
                    // var geometry = new q.a();
                    // var planeMesh= new V.a( geometry, material );
                    // // add it to the WebGL scene
                    // this.add(planeMesh);
                    // var element = document.createElement( 'img' );
                    // element.src = 'https://pbs.twimg.com/profile_images/1394371322868867075/TQ16Bz3Z_400x400.jpg';
                ...
                value: function() {
                    ...
                    this.badge.position.y = 600 > this.timeline.c.size.w ? -this.timeline.c.size.h + 90 : -this.timeline.c.size.h / 2 + 90,
                    600 > this.timeline.c.size.w && this.badge.scale.set(1.5, 1.5, 1),
                    this.add(this.badge)
                }
            }, {
                ...
                value: function() {
                    ...
                    i.anisotropy = this.timeline.renderer.capabilities.getMaxAnisotropy(),
                    i.magFilter = i.minFilter = te.M;
                    var n = new X.a({
                        map: i,
                        transparent: !0,
                        side: te.v,
                ...
                value: function() {
                    ...
                    s.position.set(0, -140, 0),
                    this.add(s);
                    var l = new V.a(new q.a(467,1),this.timeline.linkUnderlineMat);
                    l.position.set(0, -172, 0),
                    this.add(l),
                    this.linkBox = new V.a(new q.a(490,60),new X.a({
                        alphaTest: 0,
                        visible: !1
                    })),
          ...
          , fe = {
            ...
            // jan: ["example.png"],
            // feb: ["camera-culture.jpg"],
            // mar: ["When_To_Travel_Event_Loop_1080p.mp4.mp4"],
            // apr: ["aperture-dribbble.jpg"],
            // may: ["botanical.jpg"],
            // jun: ["its-official-video.mp4"],
            // jul: ["05.jpg"],
            // aug: ["ezgif.com-gif-to-mp4 (10).mp4"],
            // sep: ["asaro-web-live-shot_4x (2).jpg"],
            // oct: ["comp_1_1.mp4 (1).mp4"],
            // nov: ["DSC08088.jpg"],
            // dec: ["comp_1.mp4 (1).mp4"]
            oct:
                [ '2021-10-01_alrocar_1444040599162826752.png',
                  '2021-10-01_alrocar_1454354085247868929.png' ],
               nov:
                [ '2021-11-01_alrocar_1454996134959751169.png',
                  '2021-11-01_alrocar_1464236697546371077.png',
                  '2021-11-01_alrocar_1465811132954800131.png' ],
               dec:
                [ '2021-12-01_alrocar_1474370571936972806.png',
                  '2021-12-01_alrocar_1473026963157757955.png',
                  '2021-12-01_alrocar_1468670614227533824.png',
                  '2021-12-01_alrocar_1470814977690943495.png',
                  '2021-12-01_alrocar_1453519496761823240.png' ],
               jan:
                [ '2021-01-01_alrocar_1353451508000583681.png',
                  '2021-01-01_alrocar_1354118872723578881.png',
                  '2021-01-01_alrocar_1344819342731575297.png' ],
               feb:
                [ '2021-02-01_alrocar_1361673237206355969.png',
                  '2021-02-01_alrocar_1362039035070455810.png',
                  '2021-02-01_alrocar_1356866213016571905.png' ],
               mar:
                [ '2021-03-01_alrocar_1370463580420722688.png',
                  '2021-03-01_alrocar_1366360260592689156.png',
                  '2021-03-01_alrocar_1370955195643928577.png' ],
               apr:
                [ '2021-04-01_alrocar_1379380630815932424.png',
                  '2021-04-01_alrocar_1380149357496918020.png',
                  '2021-04-01_alrocar_1388121095597854725.png' ],
               may:
                [ '2021-05-01_alrocar_1390599855236689920.png',
                  '2021-05-01_alrocar_1393233036901289990.png',
                  '2021-05-01_alrocar_1397656482020216832.png' ],
               jun:
                [ '2021-06-01_alrocar_1408089176017453059.png',
                  '2021-06-01_alrocar_1408097531725332482.png',
                  '2021-06-01_alrocar_1407900623622873091.png' ],
               jul:
                [ '2021-07-01_alrocar_1412865136394657794.png',
                  '2021-07-01_alrocar_1415811076088680451.png' ],
               aug:
                [ '2021-08-01_alrocar_1427559310721179665.png',
                  '2021-08-01_alrocar_1427925790264635393.png',
                  '2021-08-01_alrocar_1422681013176651787.png' ],
               sep:
                [ '2021-09-01_alrocar_1440755059508146183.png',
                  '2021-09-01_alrocar_1437518532653236225.png',
                  '2021-09-01_alrocar_1441769267909697539.png' ]
        }
          , be = {
            oct:
   { '2021-10-01_alrocar_1444040599162826752.png':
     ...
     '2021-09-01_alrocar_1441769267909697539.png':
      { caption: 'Your Top Favorited Tweet',
          ...
          , ve = function() {
            ...
            return M(e, [{
                ...
                value: function() {
                    ...
                    new ge.a(this.easterEgg),
                    this.easterEggEnabled = !1,
                    this.enableLoader || (document.querySelector(".loading").style.display = "none")
                }
            }, {
                key: "isMobile",
                value: function() {
                ...
                value: function() {
                    ...
                    this.scene.background = new W.a(11454403),
                    this.scene.fog = new F.a(11454403,1400,2e3),
                    this.scene.scale.set(this.c.globalScale, this.c.globalScale, 1);
                    var o = 800
                    , i = 180 * (2 * t(this.c.size.h / 2 / o)) / P;
                    this.camera = new A.a(i,this.c.size.w / this.c.size.h,1,2e3),
                    // this.csscontrols = new THREE.TrackballControls(this.camera, this.cssRenderer.domElement);
                    this.camera.position.set(0, this.enableLoader ? 2e3 : 0, o),
                    this.raycaster = new B.a,
                    this.raycaster.near = this.camera.near,
                    this.raycaster.far = this.camera.far,
                    this.intersects = [],
                    this.linkIntersect = [],
                    this.whooshIntersects = [],
                    this.frustum = new H.a,
                    this.cameraViewProjectionMatrix = new U.a,
                    this.mouse = new Y.a,
                    this.mousePerspective = new Y.a,
                    // window.cssRenderer.domElement.style.zIndex   = 1,
                ...
                value: function() {
                    var e = this;
                    this.timeline = new G.a,
                    this.scene.add(this.timeline),
                    this.textMat = new X.a({
                        color: 1786584,
                        transparent: !0
                    }),
                    ...
                    for (var n in this.months)
                        i(n);
                    this.videoCount = this.videoItems.length,
                    this.contactSection = new de({
                        timeline: timeline,
                        section: "contact"
                    }),
                    this.contactSection.visible = !1,
                    ...
                    this.link = new V.a(a,this.captionTextMat),
                    this.linkUnderline = new V.a(new q.a(45,1),this.linkUnderlineMat),
                    this.linkUnderline.position.set(0, -10, 0),
                    this.linkBox = new V.a(new q.a(70,20),new X.a({
                        alphaTest: 0,
                        visible: !1
                    })),
                ...
                value: function(e) {
                    var t = this;
                    if (this.itemAnimating = !0,
                    this.itemOpen = e,
                    this.origTimelinePos = this.timeline.position.z,
                    this.c.allowScrolling = !1,
                    this.c.isMobile) {
                        var o = e.mesh.material.uniforms.texture.value;
                        "video" === o.mediaType && (o.image.src = "assets/" + o.name,
                        o.image.play())
                    }
                    var i = this.sections[this.activeMonth].position.z;
                    e.month !== this.activeMonth && (i = this.sections[this.remainingMonths[this.remainingMonths.length - 2]].position.z),
                    J.a.to(e.position, 1.5, {
                        x: 0,
                        y: 0,
                        ease: "Expo.easeInOut",
                        onComplete: function() {
                            t.itemAnimating = !1,
                            t.dom.cursor.dataset.cursor = "cross"
                        }
                    }),
                    ...
                    for (var a in this.items)
                        0 === this.items[a].align && n.set(-700, 700),
                        1 === this.items[a].align && n.set(700, 700),
                        2 === this.items[a].align && n.set(700, -700),
                        3 === this.items[a].align && n.set(-700, -700),
                        this.items[a] === e || (J.a.to(this.items[a].material.uniforms.opacity, 1.3, {
                            value: 0,
                            ease: "Expo.easeInOut"
                        }),
                ...
                value: function() {
                    ...
                    if (!this.itemAnimating && this.itemOpen) {
                        ...
                        this.c.isMobile) {
                            ...
                            "video" === t.mediaType && (t.image.pause(),
                            t.image.src = "",
                            t.image.load())
                        }
                        ...
                        J.a.to([this.captionTextMat, this.linkUnderlineMat], .4, {
                            ...
                            ease: "Expo.easeInOut",
                            onComplete: function() {
                                e.captionTextMat.visible = !1,
                                e.linkUnderlineMat.visible = !1,
                                e.itemOpen.caption && (e.itemOpen.caption.visible = !1),
                                e.linkGroup.visible = !1
                            }
                        }),
                        this.items)
                            this.items[o].active || (J.a.to(this.items[o].material.uniforms.opacity, 1.5, {
                                value: 1,
                                ease: "Expo.easeInOut"
                            }),
                ...
                value: function(t) {
                    ...
                    this.contactSection.isOpen ? this.closeContact() : void (this.dom.cursor.dataset.cursor = "cross",
                    this.contactSection.visible = !0,
                    this.contactSection.isOpen = !0,
                    this.c.allowScrolling = !1,
                    this.linkUnderlineMat.visible = !0,
                    this.linkUnderlineMat.opacity = .3,
                    J.a.to(this.camera.position, 2, {
                ...
                value: function() {
                    var e = this;
                    this.timeline.visible = !0,
                    this.contactSection.isOpen = !1,
                    J.a.to(this.camera.position, 2, {
                        y: 0,
                        ease: "Expo.easeInOut",
                        onComplete: function() {
                            e.contactSection.visible = !1,
                            e.c.allowScrolling = !0,
                            e.linkUnderlineMat.visible = !1,
                ...
                value: function(t) {
                    ...
                    t.preventDefault(),
                    t.stopPropagation(),
                    this.easterEggEnabled || (this.c.holdingMouseDown = !0,
                    this.contactSection.isOpen ? 0 < this.linkIntersect.length ? this.linkIntersect[0].object.onClick && this.linkIntersect[0].object.onClick() : this.closeContact() : this.itemOpen ? 0 < this.linkIntersect.length ? this.linkIntersect[0].object.onClick && this.linkIntersect[0].object.onClick() : this.closeItem() : 0 < this.intersects.length ? (this.openItem(this.intersects[0].object.parent),
                    this.dom.cursor.dataset.cursor = "cross") : this.hoveringWhoosh ? (this.c.scrolling = !0,
                    J.a.to(this.c, 4, {
                        scrollPos: 0,
                        ease: "Expo.easeInOut",
                        onUpdate: function() {
                ...
                key: "mouseUp",
                value: function() {
                    this.itemOpen || (this.dom.cursor.dataset.cursor = "pointer"),
                    this.c.holdingMouseDown = !1,
                    J.a.killTweensOf(this.c, {
                        autoMoveSpeed: !0
                    }),
                ...
                key: "mouseMove",
                value: function(t) {
                    this.mousePerspective.x = t.clientX / window.innerWidth - .5,
                    this.mousePerspective.y = t.clientY / window.innerHeight - .5,
                    this.updatingPerspective = !0,
                    this.c.touchEnabled || J.a.to(".cursor", 1.5, {
                        x: t.clientX,
                        y: t.clientY,
                        ease: "Power4.easeOut"
                    }),
                    !this.renderer || t.target !== this.renderer.domElement || this.easterEggEnabled || (this.mouse.x = 2 * (t.clientX / this.renderer.domElement.clientWidth) - 1,
                    ...
                    this.hoveringWhoosh = !1,
                    this.sections.end.arrowTween.timeScale(1))) : (this.intersects = this.raycaster.intersectObjects(this.itemMeshes),
                    0 < this.intersects.length ? this.dom.cursor.dataset.cursor = "eye" : "pointer" !== this.dom.cursor.dataset.cursor && (this.dom.cursor.dataset.cursor = "pointer"))),
                    !this.contactSection.isOpen && this.itemOpen && this.itemOpen.data.link && (this.linkIntersect = this.raycaster.intersectObject(this.linkBox),
                    0 < this.linkIntersect.length ? this.dom.cursor.dataset.cursor = "eye" : "cross" !== this.dom.cursor.dataset.cursor && (this.dom.cursor.dataset.cursor = "cross")),
                    this.contactSection.isOpen && (this.linkIntersect = this.raycaster.intersectObject(this.contactSection.linkBox),
                    0 < this.linkIntersect.length ? this.dom.cursor.dataset.cursor = "eye" : "cross" !== this.dom.cursor.dataset.cursor && (this.dom.cursor.dataset.cursor = "cross")))
                }
            }, {
                ...
                value: function(t) {
                    this.orientation.gamma = t.gamma ? t.gamma : 0,
                    this.orientation.beta = t.beta ? t.beta : 0,
                    this.initialOrientation || (this.initialOrientation = {
                ...
                value: function() {
                    ...
                    t || this.remainingMonths[this.remainingMonths.length - 1] && this.activeMonth !== this.remainingMonths[this.remainingMonths.length - 1]) {
                        ...
                        var o, i = new W.a(this.months[this.activeMonth].bgColor), n = new W.a(this.months[this.activeMonth].textColor), a = new W.a(this.months[this.activeMonth].tintColor);
                        ...
                        this.items)
                            J.a.to(this.items[r].uniforms.gradientColor.value, 1, {
                                r: a.r,
                                g: a.g,
                                b: a.b,
                                ease: "Power4.easeOut"
                        ...
                        if (this.months[this.activeMonth].outlineTextColor) {
                            ...
                            o = s.getHexString(),
                            J.a.to([this.textOutlineMat.color], 1, {
                                r: s.r,
                                g: s.g,
                                b: s.b,
                                ease: "Power4.easeOut"
                            ...
                            o = n.getHexString();
                        this.months[this.activeMonth].contactColor ? this.contactTextMat.color.set(this.months[this.activeMonth].contactColor) : this.contactTextMat.color.set(16777215),
                        J.a.to(this.dom.mainSvgs, 1, {
                            fill: "#".concat(o),
                            ease: "Power4.easeOut"
                        }),
                ...
                key: "animate",
                value: function() {
                    if (this.animationId = requestAnimationFrame(this.animate.bind(this)),
                    !this.c.touchEnabled && this.updatingPerspective && (this.updatePerspective(),
                    this.updatingPerspective = !1),
                    0 < this.c.autoMoveSpeed && (this.c.scrolling = !0,
                    this.c.scrollPos += this.c.autoMoveSpeed),
                    this.c.allowScrolling && this.c.scrolling) {
                        0 >= this.c.scrollPos && (this.c.scrollPos = 0),
                        this.c.scrollPos >= -this.stopScrollPos && (this.c.scrollPos = -this.stopScrollPos);
                        var e = (this.c.scrollPos - this.timeline.position.z) / 12;
                        this.timeline.position.z += e,
                        !this.c.isMobile && 8 > j(e) && this.handleVideos(),
                        this.easterEggEnabled || this.changeColours(),
                        700 > this.timeline.position.z && J.a.set(this.sections.intro.circle.rotation, {
                            z: "+=" + .005 * e
                        }),
                ...
                value: function() {
                    ...
                    this.camera.fov = 180 * (2 * t(this.c.size.h / 2 / this.camera.position.z)) / P,
                ...
                value: function() {
                    ...
                    // this.cssRenderer.domElement.addEventListener("touchstart", function(o) {
                    //     if (1 === o.touches.length) {
                    //         var e = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop;
                    //         t = 0 === e
                    //     }
                    // }),
                    // this.cssRenderer.domElement.addEventListener("touchmove", function(o) {
                    //     t && (t = !1,
                    //     o.preventDefault())
                    // })
                }
                ...
                value: function() {
                    if (this.timelineEntered) {
                        console.log("CHEATER!"),
                        this.easterEggEnabled = !0,
                        J.a.to(this.timeline.rotation, 2, {
                            z: 360 * P / 180,
                            ease: "Power4.easeInOut"
                        }),
                        this.discoColours();
                        for (var e = 0; e < this.itemMeshes.length - 1; e++)
                            J.a.to(this.itemMeshes[e].rotation, 2, {
                                z: 360 * P / 180,
                        ...
                        this.sections)
                            J.a.to(this.sections[t].children[0].position, 1, {
                                z: 150,
                                repeat: -1,
                                yoyo: !0,
                                ease: "Linear.easeNone"
        ...
        e.hot.dispose(function() {
            window.assets = ye.assets,
            ye.renderer.domElement.removeEventListener("wheel", ye.scroll),
            removeEventListener("resize", ye.resize),
            ye.renderer.domElement.removeEventListener("mousedown", ye.mouseDown),
            ye.renderer.domElement.removeEventListener("mouseup", ye.mouseUp),
            removeEventListener("mousemove", ye.mouseMove),
            document.querySelector("canvas").remove(),
            ye.renderer.forceContextLoss(),
            ye.renderer.context = null,
            ye.renderer.domElement = null,
            ye.renderer = null,
